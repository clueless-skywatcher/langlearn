...
Telugu is written in an **abugida**: a consonant letter carries a vowel inside
it, and marks override that vowel. A learner coming from an alphabet cannot
read a single word until that system is understood, so this course spends its
first five sections and two checkpoints on the script alone — and drills it at
length rather than presenting a chart and moving on.

Rule numbering is continuous (renumbered after authorship). Sections marked ✅
are authored.

---

## A1 — The script, and the first sentences

| # | Section | Contents |
|---|---|---|
| 01 | ✅ The Vowels — అచ్చులు | the sixteen independent vowels; short and long; the Dravidian ఎ and ఒ; the diphthongs; the vocalic letters; the తలకట్టు; when an independent vowel is written |
| 02 | ✅ The Consonants I — the Five Vargas | the inherent vowel; the 5 × 5 grid by place and manner; aspiration; retroflex against dental; the five nasals |
| 03 | ✅ The Consonants II — Outside the Grid | the semivowels; the sibilants; ళ, ఱ and క్ష; the anusvāra and the visarga |
| — | ✅ **Checkpoint 1** | covers 01–03 — the whole varṇamāla |
| 04 | ✅ The Vowel Signs — గుణింతం | the sign that replaces the inherent vowel; the guṇintam; where signs are written; why there is no sign for అ; how the consonant changes shape |
| 05 | ✅ Muting, Joining, and the Digits | the పొల్లు; the ఒత్తు and conjuncts; doubled consonants; the ten digits; reading a whole word |
| 06 | ✅ First Sentences | the verbless equational sentence; ఇది and అది; denial with కాదు; నా and నీ; నా against మా; the invariable adjective; ఏమిటి and ఎవరు |
