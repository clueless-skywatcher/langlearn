...
The A1 inventory follows the Lithuanian state programme for third-country
nationals (Soros International House / EIF, 210 hours, A1.1–A1.4), which is
itself built on the CEFR. That programme teaches grammar through communicative
...
|---|---|---|
| 01 | ✅ The Alphabet, Sounds, and Stress | alphabet, pronunciation, free and mobile stress |
| 02 | ✅ Nouns, Gender, and the Verb Būti | *būti* in the present, nominative, adjective agreement, absence of the article |
| 03 | ✅ The Accusative, Transitive Verbs, and Negation | accusative of the object, negation, first conjugation |
| — | ✅ **Checkpoint 1** | covers 01–03 |
| 04 | ✅ The Genitive | possession; origin (*iš kur esi*); the genitive after negation; the partitive (*kilogramas obuolių*); *be, iš, nuo, iki, prie, ant* |
| 05 | ✅ The Three Conjugations | present of all three (-a, -o, -i); *mėgti, norėti* + accusative / infinitive |
| 06 | ✅ Pronouns | personal pronouns in all the cases met; the indeclinable possessives *mano, tavo, jo, jos, mūsų, jūsų, jų*; reflexive *savo* |
| 07 | ✅ Questions | *ar*; *kas, ką, ko, kur, kada, kaip, kodėl, kiek, koks*; word order in questions |
| — | ✅ **Checkpoint 2** | covers 04–07 |
...
Numbering continues from A1. Items that the A1 programme already covers —
